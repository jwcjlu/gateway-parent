...
public interface EtcdClient {
     ...
     * @return
     */
    List<KeyValue> getKey(String key);
    ...
    /**
     * unregister all  data lister for specified path.
     *
     * @param path     the path to be unwatched .
     *
     */
    ...
    /**
     * @param path
     * @param listener if data changed, listener will be triggered.
     */
    String addDataListener(String path, DataListener listener);

    /**
     * @param path       the path to be watched when data  delete or update
     * @param listener   when data is changed,listener will be trigged
     * @param <T>watcher if find else null
     * @return
     */
    <T> T getDataListener(String path, DataListener listener);

    /**
     * unregister children lister for specified path.
     *
     * @param path     the path to be unwatched .
     * @param listener when data is changed , lister will be trigged.
     */
     ...
     *
     */
    void removeDataListener(String path);
